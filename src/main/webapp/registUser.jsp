	...
	$(document).ready(function () {
		...
		$(".send").click(function () {
			...
			if(null != phone && phone !=''){
				...
				$.ajax({
					url: "${ctx}/registUser/sendMeseege/0",
			        type: "get",
			        dataType: "json",
			        data: {
	                	mobilephone:phone
...
<div class="top">
    <div class="container clearfix">
        ...
        <div class="phone_icon"><img src="${ctx}/static/img/phone_icon.png" alt=""/> +86 400 234 6666</div>
    </div>
</div>
<div class="header" id="home" style="height:auto;padding:10px 0;text-align:left;">
    <div class="login_head">
        ...
        <span>碧峰峡</span> <span>|</span> <span>注册中心</span>
    </div>
</div>
<!----end-header---->
<div class="findpwd_wrap">
    <div class="findpwd_content">
        <form id="userInfo" action="${ctx}/registUser/regRegistUser" method="post" class="findpwd_form clearfix">
            <label for="">
                <span>手机号</span>
            ...
            <label for="">
                ...
                <a href="javascript:;" class="send_detail">发送中<span class="send_detailsend">50</span>s</a>
            </label>
            <label for="">
                <span>新密码</span>
            ...
            <label for="" class="accept_label">
                <input type="checkbox" checked="checked" disabled="disabled" style="width: auto;vertical-align: middle;margin-right:4px;"><a href="" class="accept">我已阅读并同意《碧峰峡网站用户须知》</a>
            </label>
            <button id="regs" type="button">注册</button>
