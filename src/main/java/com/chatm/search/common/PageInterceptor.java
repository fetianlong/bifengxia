package com.chatm.search.common;
...
public class PageInterceptor implements Interceptor {
     ...
     * @author pujianhua  
     * @createtime 2016年4月18日 下午3:17:08
     */
    private String getPostgresqlPageSql(MyPage<?> page, StringBuffer sqlBuffer) {  
    	//计算第一条记录的位置，Mysql中记录的位置是从0开始的。  
    	int offset = (page.getNumber() - 1) * page.getSize();  
    	sqlBuffer.append(" limit ").append(page.getSize()).append(" offset ").append(offset);  
    	return sqlBuffer.toString();  
    }  
