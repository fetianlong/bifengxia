...
import com.chatm.search.controller.IndexController;
/**
 * 碧峰峡短信接口
 * @author pu
 *
...
public class MessageClient1 {
	private static Logger logger = LoggerFactory.getLogger(MessageClient1.class);
	/*
	 * webservice服务器定义
	 */
...
//	private String serviceURL = "http://report.zucp.net:8060/reportservice.asmx";
	 ...
	 * 构造函数
	 */
	public MessageClient1(String sn, String password)
...
//			bout.write(xml.getBytes());
			...
			logger.error("MessageClient mdsmssend error：" + e.getLocalizedMessage());
			e.printStackTrace();
			return "";
		}
	}
