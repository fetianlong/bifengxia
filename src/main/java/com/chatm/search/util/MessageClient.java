...
public class MessageClient {
	...
	public String mdgetSninfo() {
		...
		try {
			...
			e.printStackTrace();
			logger.error("短信接口连接调用失败-mdgetSninfo：" + e.getLocalizedMessage());
			return "";
		}finally {
			try {
				if (bout!=null) {
				...
				logger.error("短信接口连接释放失败-mdgetSninfo：" + e2.getLocalizedMessage());
			}
		}
	}
	...
	public String mdgxsend(String mobile, String content, String ext, String stime,
		...
		try {
			...
			e.printStackTrace();
			logger.error("短信接口调用失败-mdgxsend：" + e.getLocalizedMessage());
			return "";
		}finally {
			try {
				if (bout!=null) {
				...
				logger.error("短信接口连接释放失败-mdgxsend：" + e2.getLocalizedMessage());
			}
		}
	}
	...
	public String mdsmssend(String mobile, String content, String ext, String stime,
		...
		try {
			...
			e.printStackTrace();
			logger.error("短信接口调用失败-mdsmssend：" + e.getLocalizedMessage());
			return "";
		}finally {
			try {
				if (bout!=null) {
